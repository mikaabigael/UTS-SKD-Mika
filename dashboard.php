...
<body>
    ...
    <div class="py-5 bg-image-full" id="tentang" style="background-image: url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS7t9eJysthUYoayHuGgyE2RLCxo53YcedQTA&usqp=CAU')">
    ...
    <div class="py-5 bg-image-full" style="background-image: url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTJpaIaVNnGzu-H3ZfTzqdbjaLnQThluN5ZYQ&usqp=CAU')">
        <!-- Put anything you want here! The spacer below with inline CSS is just for demo purposes!-->
